...
left join {{ ref('dim_insumo') }} di on m.id_insumo_nk = di.id_insumo_nk 
    and m.fecha_hora_movimiento >= di.valido_desde and (m.fecha_hora_movimiento < di.valido_hasta or di.valido_hasta is null)
